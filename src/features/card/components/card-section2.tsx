...
import { firstLetterToUpperCaseFormatter } from "../../../shared/utils/utilities.ts";
import { type PropsWithChildren } from "react";
import type { CardProps } from "../types.js";
import type { DisplayedProduct } from "../../../shared/types/types.js";

const CardSection2: React.FC<PropsWithChildren<CardProps>> = React.memo(
  ({ product }) => {
    return (
      <div className="flex flex-col w-full">
        ...
        <div className="mb-5">
          ...
          <ul>
            {product?.ingredients_visible.map(
        ...
        {Object.entries(
          Object.keys(product)
            ...
            .reduce<DisplayedProduct>((newObj, key) => {
              newObj[key] = product[key];
              return newObj;
            }, {} as DisplayedProduct)
        ).map(([key, value]: [string, string | string[]], i) => (
          <span key={i}>
